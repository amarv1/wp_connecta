    ...
    <div id="carousel" class="slide carousel carousel-fade">
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="container">
                    <div class="carousel-caption b-slider__info">
                        <h3>Prepustite to nama</h3>
                        <h2>Fleet management</h2>
                        <p>Specijalizirani smo za upravljanje vašim voznim parkom</p>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="carousel-caption b-slider__info">
                        <h3>Odaberite automobil</h3>
                        <h2>Prodaja vozila</h2>
                        <p>Mazda, Ford Cargo, Rabljena</p>
                        <a class="btn m-btn" href="detail.html">Detaljnije<span class="fa fa-angle-right"></span></a>
                    </div>
                    <div class="slider-overlay"></div>
                </div>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="carousel-caption b-slider__info">
                        <h3>Budite sigurni</h3>
                        <h2>Nokian gume</h2>
                        <p>Ovlašteni smo distributer nokian guma</p>
        ...
        <div class="row wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
            <div class="col-xs-4">
                <div class="b-contact-title">
                    <h5>NOVOSTI I PONUDE</h5><br />
                    <h2>NEWSLETTER ČLANSTVO</h2>
                </div>
            </div>
            <div class="col-xs-8">
                <div class="b-contact__form">
                    <p>NAJNOVIJE PONUDE I INFORMACIJE O NAŠIM USLUGAMA NA VAŠ EMAIL. UČLANITE SE, BESPLATNO JE!</p>
...
">
                <div class="b-welcome__text wow zoomInUp" data-wow-delay="0.3s" style="visibility: visible;animation-delay: 0.3s;animation-name: zoomInUp;color: #444;">
                    <h2>VAŠ POUZDANI PARTNER</h2>
                    <h3>DOBRODOŠLI U CONNECTU</h3>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                <div class="b-asks__first wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <div class="b-asks__first-info">
                        <h2>ŽELITE VIŠE INFORMACIJA O NAŠIM USLUGAMA?</h2>
                        <p>Lorem ipsum dolor sit amet qui donk ba fuskaliton dolor. Ino paco sunsui basic tiholkitu.</p>
                    </div>
            ...
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-xs-12 col-md-offset-0">
                <div class="b-asks__first m-second wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <div class="b-asks__first-info">
                        <h2>ŽELITE ZAKAZATI TERMIN ZA SERVIS VOZILA?</h2>
                        <p>Pozovite nas i naše ljubazno osoblje će za pripremiti termin prilagođen vašim obavezama.</p>
                    </div>
                    <div class="b-asks__first-arrow">
                        <a href="listingsTwo.html"><span class="fa fa-angle-right"></span></a>
                    </div>
            ...
            <div class="col-xs-12">
                <p class="b-asks__call wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">IMATE PITANJA? POZOVITE NAS  : <span>+387 33 778 000</span></p>
            </div>
        </div>
    </div>
</section><!--b-asks-->
